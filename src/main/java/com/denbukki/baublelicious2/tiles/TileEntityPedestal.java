...
import com.denbukki.baublelicious2.util.PlayerHelper;
...
public class TileEntityPedestal extends TileEntity implements ITickable {
    ...
    public ItemStackHandler inventory = new ItemStackHandler(1) {
        ...
        protected void onContentsChanged(int slot) {
            if (!world.isRemote) {
                Baublelicious2.network.sendToAllAround(new PacketUpdatePedestal(TileEntityPedestal.this), new NetworkRegistry.TargetPoint(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), 64));
            }
        }
    };
    ...
    public void onLoad() {
        if (world.isRemote) {
            Baublelicious2.network.sendToServer(new PacketRequestUpdatePedestal(this));
        }
    }
