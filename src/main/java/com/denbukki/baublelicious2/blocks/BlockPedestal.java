...
public class BlockPedestal extends  BlockBaseContrainer {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        worldIn.setBlockState(pos, Baublelicious2Blocks.blockPedestal.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!world.isRemote) {
            if (!player.isSneaking()) {
                player.openGui(Baublelicious2.instance, Baublelicious2GuiHandler.PEDESTAL, world, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
